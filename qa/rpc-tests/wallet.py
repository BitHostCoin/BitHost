...
#   c) node1 mines 32 blocks, so now node 0 has 60001bih, node 1 has 4250bih, node2 has none.
#   d) node0 sends 601 bih to node2, in two transactions (301 bih, then 300 bih).
