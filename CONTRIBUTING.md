Contributing to Bithost Core
============================

The Bithost Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bithost Core project, and is not to be
confused with overall Bithost Network Protocol consensus changes.

Whether a pull request is merged into Bithost Core rests with the project merge
...
Patches that change Bithost consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bithost consensus, it must have been
...
The project leader is the release manager for each Bithost Core release.
