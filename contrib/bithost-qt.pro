...
RESOURCES += src/qt/bithost.qrc src/qt/bithost_locale.qrc

TRANSLATIONS += src/qt/locale/bithost_bg.ts \
                src/qt/locale/bithost_de.ts \
                src/qt/locale/bithost_en.ts \
                src/qt/locale/bithost_es.ts \
                src/qt/locale/bithost_fi.ts \
                src/qt/locale/bithost_fr.ts \
                src/qt/locale/bithost_it.ts \
                src/qt/locale/bithost_ja.ts \
                src/qt/locale/bithost_pl.ts \
                src/qt/locale/bithost_pt.ts \
                src/qt/locale/bithost_ru.ts \
                src/qt/locale/bithost_sk.ts \
                src/qt/locale/bithost_sv.ts \
                src/qt/locale/bithost_vi.ts \
                src/qt/locale/bithost_zh_CN.ts \
                src/qt/locale/bithost_zh_TW.ts
