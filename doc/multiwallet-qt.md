...
In order to support loading of multiple wallets in bithost-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bithost.cpp.
...
Changes to bithost.cpp
----------------------
bithost.cpp is the entry point into bithost-qt, and as such, will require some minor modifications to provide hooks for
