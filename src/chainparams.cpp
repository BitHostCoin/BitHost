...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 29918;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Bithost starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Bithost: 1 day
        ...
        nZerocoinStartTime = 1539768600; // Monday, October 1, 2018 8:00:00 AM
        ...
        nBlockZerocoinV2 = 101; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
        nEnforceNewSporkKey = 1539774060; //!> Sporks signed after (GMT): Tuesday, October 9, 2018 10:00:00 AM GMT must use the new spork key
        nRejectOldSporkKey = 1539774000; //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Russian Accused of Hacking Public Servers to Mine Bitcoin Faces up to Five Years in Prison.";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1539768600;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 4063074;
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zbih to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "bithost-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "bithost-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bithost addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bithost script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bithost BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bithost BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bithost BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Bithost: 1 day
        nTargetSpacing = 1 * 60;        // Bithost: 1 minutes
