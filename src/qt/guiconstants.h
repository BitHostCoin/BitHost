...
/* Bithost GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bithost"
#define QAPP_ORG_DOMAIN "bithost.org"
#define QAPP_APP_NAME_DEFAULT "Bithost-Qt"
#define QAPP_APP_NAME_TESTNET "Bithost-Qt-testnet"
