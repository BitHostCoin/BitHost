                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBIHPathCustom = GetArg("-zbihbackuppath", "");
    ...
    if(!strzBIHPathCustom.empty()) {
        ui->wallet_customzbihbackuppath->setText(QString::fromStdString(strzBIHPathCustom));
        ui->wallet_customzbihbackuppath_label->setVisible(true);
        ui->wallet_customzbihbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBIHPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bithost RPC console.") + "<br>" +
