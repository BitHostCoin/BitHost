...
/** Utility functions used by the Bithost Qt UI.
 */
namespace GUIUtil
{
...
// Render Bithost addresses in monospace font
...
// Parse "bithost:" URI into recipient object, return true on successful parsing
