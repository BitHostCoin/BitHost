...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Bithost server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bithost features */
        {"bithost", "masternode", &masternode, true, true, false},
        {"bithost", "listmasternodes", &listmasternodes, true, true, false},
        {"bithost", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bithost", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bithost", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bithost", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bithost", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bithost", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bithost", "masternodedebug", &masternodedebug, true, true, false},
        {"bithost", "startmasternode", &startmasternode, true, true, false},
        {"bithost", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bithost", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bithost", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bithost", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bithost", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bithost", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bithost", "mnbudget", &mnbudget, true, true, false},
        {"bithost", "preparebudget", &preparebudget, true, true, false},
        {"bithost", "submitbudget", &submitbudget, true, true, false},
        {"bithost", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bithost", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bithost", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bithost", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bithost", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bithost", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bithost", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bithost", "checkbudgets", &checkbudgets, true, true, false},
        {"bithost", "mnsync", &mnsync, true, true, false},
        {"bithost", "spork", &spork, true, true, false},
        {"bithost", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbihseed", &getzbihseed, false, false, true},
        {"zerocoin", "setzbihseed", &setzbihseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbih", &searchdzbih, false, false, true},
        {"zerocoin", "dzbihstate", &dzbihstate, false, false, true}
...
{
    return "> bithost-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29917/\n";
}
