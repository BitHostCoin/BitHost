...
/**
 * Bithost RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzbihseed(const UniValue& params, bool fHelp);
extern UniValue getzbihseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbih(const UniValue& params, bool fHelp);
extern UniValue dzbihstate(const UniValue& params, bool fHelp);
