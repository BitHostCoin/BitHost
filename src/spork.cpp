...
// Bithost: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_18_CHANGE_COLLATERAL_ENFORCEMENT) r = SPORK_18_CHANGE_COLLATERAL_ENFORCEMENT_DEFAULT;  
        if (nSporkID == SPORK_19_ADDRESS_TOBAN_ENFORCEMENT) r = SPORK_19_ADDRESS_TOBAN_ENFORCEMENT_DEFAULT;         
        if (nSporkID == SPORK_20_MASTERNODE_ON_NODEF_PORT) r = SPORK_20_MASTERNODE_ON_NODEF_PORT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_18_CHANGE_COLLATERAL_ENFORCEMENT") return SPORK_18_CHANGE_COLLATERAL_ENFORCEMENT;
    if (strName == "SPORK_19_ADDRESS_TOBAN_ENFORCEMENT") return SPORK_19_ADDRESS_TOBAN_ENFORCEMENT;     
    if (strName == "SPORK_20_MASTERNODE_ON_NODEF_PORT") return SPORK_20_MASTERNODE_ON_NODEF_PORT;     
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_18_CHANGE_COLLATERAL_ENFORCEMENT) return "SPORK_18_CHANGE_COLLATERAL_ENFORCEMENT";    
    if (id == SPORK_19_ADDRESS_TOBAN_ENFORCEMENT) return "SPORK_19_ADDRESS_TOBAN_ENFORCEMENT";     
    if (id == SPORK_20_MASTERNODE_ON_NODEF_PORT) return "SPORK_20_MASTERNODE_ON_NODEF_PORT";     
